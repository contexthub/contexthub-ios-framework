 ...
 */
- (void)application:(UIApplication *)application didReceiveRemoteNotification:(NSDictionary *)userInfo completionHandler:(void(^)(enum UIBackgroundFetchResult result, CCHContextHubPush *CCHContextHubPush))completionHandler;
